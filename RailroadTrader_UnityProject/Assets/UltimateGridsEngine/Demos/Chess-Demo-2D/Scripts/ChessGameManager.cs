...
public class ChessGameManager : MonoBehaviour {
    ...
    public GridObject m_SelectedPiece = null;   // Currently highlighted GridTile
    ...
    public GridObject TrySelectPieceAtTile(GridTile targetTile) {
        var piece = GridManager.GetGridObjectAtPosition(targetTile.m_GridPosition);
    ...
    public bool FriendlyPieceAt(Vector2Int gridPosition) {
        GridObject piece = GridManager.GetGridObjectAtPosition(gridPosition);
    ...
    public void CapturePieceAt(Vector2Int gridPosition) {
        GridObject pieceToCapture = GridManager.GetGridObjectAtPosition(gridPosition);
